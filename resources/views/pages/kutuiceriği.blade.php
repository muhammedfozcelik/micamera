...
<head> 
  ...
  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
	<title>Kutu İçeriği</title>
</head>
<body>
  <div class="mt-5" >
  
<img src="{{URL::asset('/pictures/kutu.jpg')}}" class="img-fluid w-100 h-100" alt="Responsive image">
  

</div>
<div class="mt-3 mb-3" style="z-index: 100;">
  
<img src="{{URL::asset('/pictures/kutuiceriği.jpg')}}" class="img-fluid" alt="Responsive image">
